...
echo "10.252.0.246 node-A" >> /etc/hosts
echo "10.252.0.201 node-B" >> /etc/hosts
...
sudo sed -i 's/#node.name: node-1/node.name: node-B/' /etc/elasticsearch/elasticsearch.yml
